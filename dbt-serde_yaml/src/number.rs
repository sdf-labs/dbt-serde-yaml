...
impl Number {
    ...
    /// let v: dbt_serde_yaml::Value = dbt_serde_yaml::from_str(r#"
    /// a: 64
    ...
    /// ```
    /// # fn main() -> dbt_serde_yaml::Result<()> {
    /// let v: dbt_serde_yaml::Value = dbt_serde_yaml::from_str(".inf")?;
    /// assert_eq!(v.as_f64(), Some(f64::INFINITY));
    ///
    /// let v: dbt_serde_yaml::Value = dbt_serde_yaml::from_str("-.inf")?;
    /// assert_eq!(v.as_f64(), Some(f64::NEG_INFINITY));
    ///
    /// let v: dbt_serde_yaml::Value = dbt_serde_yaml::from_str(".nan")?;
